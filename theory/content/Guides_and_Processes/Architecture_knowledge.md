...
[https://youtu.be/AiJ8tRRH0f8](https://youtu.be/AiJ8tRRH0f8)
...
<Accordion items={accordionItems} left={true}/>
...
<Accordion items={tabItems} position="top" />
...
class Accordion extends React.Component {
  ...
  internalSetState(changes, callback = () => {}) {
    ...
    this.setState(state => {
      ...
      const chanhesObject = typeof changes === 'function' ? changes(actualState) : changes
